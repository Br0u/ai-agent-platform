...
- `docs/testing/assistant-runtime-acceptance.md`：补右侧工作区验收命令和预期结果。
...
```bash
git add apps/web/e2e/assistant-experience.spec.ts apps/web/e2e/pricing-assistant.spec.ts docs/testing/run-assistant-experience-e2e.sh docs/testing/assistant-runtime-acceptance.md packages/database/src/deployment-contracts.test.ts
