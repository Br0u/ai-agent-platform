...
async def _verify_migration(cursor: MigrationCursor) -> None:
    ...
    await cursor.execute(VERIFY_RUNTIME_DATA_INVARIANTS_SQL)
...
async def run_migration(
    ...
    *,
    ...
    """Upgrade through schema version ten and verify the exact access boundary."""
    ...
    async with connection:
        async with connection.cursor() as cursor:
            ...
            if version_state == (None, 0):
                ...
                await cursor.execute(SCHEMA_VERSION_10_SQL)
