export const videoAgentIntro = {
  title: "华鲲元启视觉检索一体机",
  description: "依托全国产化算力底座与多模态大模型，通过华鲲元启 AI 开发平台，打造行业视频检索智能体一体化解决方案。设备支持离线视频文件检索与摄像头实时分析，仅需简单自然语言指令，即可完成特定场景的检索与预警，涵盖实时布控、即时查找两种模式，实现精准识人、识物、识行为，可广泛应用于安防、应急、城市治理、交通等众多行业领域。",
};
...
export const hardwareConfig = {
  ...
  tableData: [
    ...
    { category: "安装实施服务", details: ["华鲲元启平台安装部署、功能验证、配置模型部署"] }
  ]
};
