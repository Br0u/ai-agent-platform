...
describe("prototype platform center content contract", () => {
  ...
  it("locks the complete product-family centers", () => {
    expect(
      ["agents", "applications", "skills", "coding", "governance"].map((slug) =>
        getPlatformCenter(slug),
      ),
      ...
      [
        {
          "business": {
            ...
            "points": [
              ...
              {
                "description": "不懂 SQL 也能查数",
                "title": "智能问数助手",
              },
              {
                "description": "视频可检索、可预警",
                "title": "视频理解助手",
              },
              {
                "description": "复杂业务自动执行",
                "title": "流程自动化引擎",
              },
            ],
            "reason": [
            ...
            "scenesLead": "覆盖企业知识问答、智能问数、视频监控与业务流程自动化等场景。",
            ...
            "values": [
              ...
              {
                "description": "像对话一样用 AI",
                "title": "使用门槛低",
              },
              {
                "description": "发布、调用、联合复用",
                "title": "一次构建处处可用",
              },
            ],
            "workflow": [
          ...
          "cta": {
            ...
            "description": "面向知识问答、智能问数、视频理解与流程自动化需求，与华鲲团队沟通。",
            "title": "需要建设企业 AI 助手？",
          },
          "hero": {
            "actions": [
          ...
          "sections": [
            {
              ...
              "cards": [
                {
                  "description": "在平台内直接与助手对话，即开即用，适合内部体验与日常使用。",
                  "title": "直接对话使用",
                },
                {
                  "description": "发布到应用广场，供组织内或指定用户按需选用，形成可复用的应用入口。",
                  "title": "应用广场发布",
                },
                {
                  "description": "通过标准接口将助手能力接入业务系统，让 AI 融入现有流程。",
                  "title": "外部调用",
                },
                {
                  "description": "把多个已发布助手组合成联合智能体，统一界面无感切换，协同完成复杂任务。",
                  "title": "联合智能体",
                },
              ],
              "eyebrow": "01｜产品介绍",
              ...
              "cards": [
                {
                  ...
                  "description": "核心价值：选好模型、关联知识库，智能体即构建完成，即配即用。",
                ...
                },
                {
                  ...
                  "description": "业务人员的价值：不用写 SQL，即可获取数据洞察；指标口径统一，结果可信。",
              ...
              "cards": [
                {
                  ...
                  "description": "文档接入、自动分片、知识图谱与 QA 补充，把企业文档沉淀为 AI 可检索、可问答的知识资产，回答可溯源。",
                  "tag": "知识底座",
                  "title": "企业知识库",
                },
                {
                  ...
                  "description": "接入企业数据源、同步原始数据、开发统一指标，让问数助手用自然语言直接查数，口径统一、结果可信。",
                  "tag": "数据底座",
                  "title": "数据源与指标",
                },
              ],
        ...
        },
        {
          "business": {
            ...
            "points": [
              {
                "description": "无需从零搭建，快速上手",
                "title": "开箱即用",
              },
              {
                "description": "面向高频场景打磨成熟",
                "title": "业务就绪",
              },
              {
                "description": "需要深化时底层随时可建",
                "title": "能力可扩展",
              },
            ],
            "reason": [
            ...
            "values": [
              {
                "description": "快速验证应用价值",
                "title": "见效快",
              },
              {
                "description": "复用成熟能力，减少重复建设",
                "title": "成本低",
              },
            ],
              ...
              "cards": [
                {
                  ...
                  "description": "面向撰写、润色与整理的通用文本场景，让高频写作任务更快完成。",
                  "tag": "通用办公",
                  "title": "通用文本写作",
                ...
                },
                {
                  ...
                  "description": "面向投标文件编写与标书要点整理的提效场景，让投标更有条理。",
                  "tag": "招投标",
                  "title": "投标智能助手",
                ...
                },
                {
                  ...
                  "description": "面向合同条款审核与规则核对的合规场景，让审查更快、口径更统一。",
                  "tag": "法务合规",
                  "title": "合同智能审查",
                  "value": "条款逐条核对，风险早发现",
        ...
        },
        {
          "business": {
            ...
            "outcomes": [
              {
                "description": "开箱即用，快速验证",
                "title": "拿来即用",
              },
              {
                "description": "能力一次封装、多处使用",
                "title": "标准化复用",
              },
              {
                "description": "技能随业务越用越厚",
                "title": "持续沉淀",
              },
            ],
            "points": [
              {
                "description": "技能开箱即用，快速验证价值",
                "title": "拿来即用",
              },
              {
                "description": "能力封装成标准技能，多处复用",
                "title": "标准化复用",
              },
              {
                "description": "企业流程、工具、知识持续沉淀",
                "title": "快速沉淀",
              },
              {
                "description": "与智能体、行业应用无缝组装",
                "title": "生态连接",
              },
            ],
            "reason": [
            ...
            "values": [
              {
                "description": "同类能力不用重复开发",
                "title": "降低重复建设",
              },
              {
                "description": "技能随业务持续沉淀",
                "title": "能力越用越厚",
              },
            ],
            "workflow": [
              ...
              "cards": [
                {
                  ...
                  "description": "模型评测、工作流生成、AI 系统知识，服务研发与工程团队。",
                  "tag": "编程类技能",
                  "title": "研发与工程提效",
                },
                {
                  ...
                  "description": "视频解析布控、Agent 安全防护，为业务应用提供可落地能力。",
                  "tag": "应用类技能",
                  "title": "业务应用能力",
                },
                {
                  ...
                  "description": "会议纪要生成、技能包入门，让日常办公与技能运营更顺畅。",
                  "tag": "办公类技能",
                  "title": "日常办公提效",
                },
              ],
              ...
              "cards": [
                {
                  ...
                  "description": "智能体通过技能中心的能力组件，快速获得标准化业务能力。",
                  "tag": "使用方",
                  "title": "智能体中心",
                },
                {
        ...
        },
        {
          "business": {
            ...
            "outcomes": [
              {
                "description": "从需求到代码，缩短开发周期",
                "title": "开发更快",
              },
              {
                "description": "规范统一、校验内建",
                "title": "质量更稳",
              },
              {
                "description": "私有化部署，核心资产可控",
                "title": "交付更安全",
              },
            ],
            "points": [
              {
                "description": "需求直接转代码，降低门槛",
                "title": "自然语言开发",
              },
              {
              ...
              {
                "description": "内置工具链，代码可执行可验证",
                "title": "真实环境落地",
              },
              {
                "description": "数据不出域，代码资产安全",
                "title": "私有化可控",
              },
            ],
            "reason": [
              ...
              "cards": [
                {
                  ...
                  "description": "语言框架多、语法细节杂，新需求从构思到可运行代码耗时较长。",
                  "number": "问题 01",
                  "title": "编码门槛怎么降？",
                },
                {
                  ...
                  "answer": "双模式工作流 + 内置工具链，在真实环境落地执行，自动化完成开发任务。",
                  "description": "样板代码、常见工具、调试排查占据大量时间，重复劳动难以避免。",
                  "number": "问题 02",
                  "title": "重复劳动怎么减？",
                },
                {
                  ...
                  "description": "团队编码风格不一、质量参差，核心代码数据安全也需严格管控。",
                  "number": "问题 03",
                  "title": "代码质量怎么保？",
                },
              ],
            ...
            },
            {
              "cards": [
                ...
                },
                {
                  ...
                  "description": "先规划方案、再执行落地，复杂任务逻辑完整，简单任务高效直接。",
                ...
                },
                {
                  ...
                  "description": "支持全链路私有化部署，代码与上下文本地处理，满足高安全场景。",
                  "title": "私有化安全可控",
                },
              ],
              "eyebrow": "02｜它是什么",
              ...
              "cards": [
                {
                  ...
                  "description": "以项目为单位组织开发，多项目隔离、上下文专注、配置独立。",
                  "number": "01",
                  "title": "项目管理",
                },
                {
                ...
                },
                {
                  ...
                  "description": "多端接入、终端 UI 可视化，随时随地查看与响应开发任务。",
                  "number": "03",
                  "title": "移动接入",
                },
                {
                  ...
                  "description": "企业编码规范统一适配，代码质量多维度校验，团队标准一致。",
                  "number": "04",
                  "title": "编程规范",
                },
              ],
        ...
        },
        {
          "business": {
            ...
            "outcomes": [
              ...
              {
                "description": "授权与使用边界统一管理",
                "title": "合规可查",
              },
            ],
            "points": [
              {
                "description": "人员进出全程可控",
                "title": "用户管理",
              },
              {
                "description": "按岗位配置权限",
            ...
            "visual": "授权链路演示素材槽位（用户 → 角色 → 菜单 / 操作权限 → 数据 / 行级权限）",
            "workflow": [
              "操作权限",
              "数据权限",
              "边界清晰可控",
              ...
              "groups": [
                ...
                },
                {
                  "cards": [
                    ...
                    {
                      "description": "控制角色对平台功能能做什么：可查看 / 可操作 / 可删除，按角色统一配置。",
                      "title": "操作权限",
                      "visual": "操作权限配置界面截图素材槽位",
                    },
                    {
                      "description": "控制角色能接触哪些数据：按组织、部门、项目圈定数据范围，可配合行级权限细化到人。",
                      "title": "数据权限",
