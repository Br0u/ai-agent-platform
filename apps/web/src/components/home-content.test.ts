...
describe("home content reference contract", () => {
  it("locks the home section copy", () => {
    expect(homeCopy).toStrictEqual({
      hero: {
  ...
  it("locks the enterprise proof points", () => {
    const expected = [
      {
        title: "数据留在企业边界内",
