...
export const skillSubpageSlugs = [
  "skills-programming",
  "skills-application",
  "skills-office",
] as const;
...
export function getSkillSubpage(slug: string): PlatformPage | undefined {
  return skillSubpages.find((page) => page.slug === slug);
}
