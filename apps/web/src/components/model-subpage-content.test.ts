  ...
  "model-optimization": {
    ...
    business: {
      ...
      points: [
        ...
        {
          title: "效果有依据",
          description: "评测数据支撑决策",
        },
        {
          title: "迭代有闭环",
          description: "评估反馈持续优化",
        },
      ],
      values: [
        {
          title: "更快懂业务",
          description: "训练让模型学会企业知识",
        },
        {
          title: "更省成本",
          description: "轻量路径先验证再投入",
        },
        {
          title: "更稳上线",
          description: "评测把关，效果有据",
        },
      ],
      ...
      outcomes: [
        {
          title: "回答更懂业务",
          description: "模型与企业知识对齐",
        },
        {
          title: "效果可验证",
          description: "每次迭代有数据支撑",
        },
        {
          title: "路径更清晰",
          description: "从备数据到上线有章法",
        },
      ],
      scenesLead:
  ...
  "model-task-center": {
    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          ...
          {
            title: "进度实时可查",
            description: "训练进度与运行状态随时可见",
          },
          {
            title: "结果衔接后续",
            description: "训练结果进入评估与发布流程",
          },
          {
            title: "用在哪里",
            points: [
      ...
      },
      {
        ...
        cards: [
          ...
          {
            title: "资源按需配置",
            description: "按评测规模选择资源执行测评",
          },
          {
            title: "结果随时可查",
            description: "评测结果与报告随时查看",
          },
          {
            title: "支撑模型决策",
            description: "为选型、优化与上线提供依据",
          },
          {
            title: "用在哪里",
    ...
    business: {
      ...
      points: [
        ...
        {
          title: "资源按需调度",
          description: "任务与资源精准匹配",
        },
        {
          title: "状态实时可见",
          description: "排队/运行/完成/失败",
        },
        {
          title: "任务灵活管理",
          description: "筛选、修改、删除",
        },
      ],
      values: [
        {
          title: "资源利用率更高",
          description: "按需调度减少闲置",
        },
        {
          title: "任务状态透明",
          description: "运行情况一目了然",
        },
        {
          title: "管理更省心",
          description: "统一入口降低运维",
        },
      ],
      demo: {
        title: "模型任务中心",
  ...
  "model-assets": {
    ...
    business: {
      ...
      values: [
        {
          title: "资产更清楚",
          description: "模型集中可见，不再分散难找",
        },
        {
          title: "选型更省事",
          description: "部署约束与支持框架有据可查",
        },
        {
          title: "落地更顺畅",
  ...
  "model-training": {
    ...
    business: {
      ...
      points: [
        {
          title: "数据准备",
          description: "训练/评测/蒸馏数据集",
        },
        {
          title: "三种训练方式",
          description: "LoRA、全参、蒸馏",
        },
        {
          title: "进度可视化",
          description: "训练过程可跟踪",
  ...
  "model-evaluation": {
    ...
    hero: {
      ...
      actions: [
        ...
        {
          label: "商务咨询",
          href: "/contact?topic=模型评估咨询",
        },
      ],
      visual: {
        title: "评估中心 / 评测结果界面截图素材槽位",
      },
    },
    sections: [
      {
    ...
    business: {
      ...
      points: [
        {
          title: "自动评测",
          description: "内置方法自动评分",
        },
        {
          title: "人工评测",
          description: "业务口径人工把关",
        },
        {
          title: "报告生成",
          description: "评测结果一键成报告",
        },
        {
          title: "对比选型",
          description: "多模型效果对比",
      ...
      values: [
        {
          title: "效果可量化",
          description: "评测报告一目了然",
        },
        {
          title: "决策有据",
          description: "选型与上线有数据支撑",
        },
        {
          title: "风险可控",
          description: "问题早发现早处理",
        },
      ],
      demo: {
        title: "模型效果评测",
  ...
  "model-data": {
    ...
    business: {
      ...
      points: [
        {
          title: "数据集创建",
          description: "训练 / 评测 / 蒸馏分类管理",
        },
        {
          title: "数据校验",
          description: "质量可控、口径一致",
        },
        {
          title: "发布复用",
          description: "进入训练评估链路",
        },
        {
          title: "资产沉淀",
          description: "知识库 QA 自动生成复用",
        },
      ],
      values: [
        {
          title: "支撑训练",
          description: "LoRA / 全参 / 蒸馏有数可用",
        },
        {
          title: "支撑评估",
          description: "自动与人工评测有据可依",
        },
      ],
      ...
      outcomes: [
        {
          title: "训练更稳",
          description: "数据口径统一、质量可控",
        },
        {
          title: "评估更准",
          description: "评测数据有据可依",
        },
        {
          title: "资产复用",
          description: "知识资产沉淀复用",
        },
      ],
      scenesLead:
  ...
  "model-deploy": {
    ...
    business: {
      ...
      points: [
        {
          title: "专网部署",
          description: "数据不出域，安全合规",
        },
        {
          title: "云端部署",
          description: "弹性扩展，快速用上新模型",
        },
        {
          title: "定制部署",
          description: "贴合个性化场景",
      ...
      outcomes: [
        {
          title: "上线更快",
          description: "部署方式选定即生成任务",
        },
        {
          title: "环境适配",
          description: "专网 / 云端 / 定制按需选择",
        },
        {
          title: "运行可控",
          description: "任务状态实时可视化",
        },
      ],
...
describe("prototype model subpage content contract", () => {
  it("registers exactly the seven model subpages in source order", () => {
    expect(modelSubpageSlugs).toStrictEqual(Object.keys(expectedPages));
    expect(getModelSubpage("unknown")).toBeUndefined();
  });

  it.each(Object.entries(expectedPages))(
    "locks the complete %s page",
    (slug, expected) => {
      expect(getModelSubpage(slug)).toStrictEqual(expected);
    },
  );
});
