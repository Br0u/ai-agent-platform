...
describe("prototype coding subpage content contract", () => {
  it("registers exactly the four coding subpages in source order", () => {
  ...
  it("locks the complete coding project page", () => {
    expect(getCodingSubpage("coding-project")).toStrictEqual({
      slug: "coding-project",
      name: "项目管理",
      hero: {
        eyebrow: "编程中心｜项目管理",
      ...
      sections: [
        ...
        },
        {
          ...
          cards: [
            ...
            {
              title: "历史会话延续",
              description: "开发决策与上下文跨会话保留",
            },
            {
              title: "当前任务聚焦",
              description: "围绕当前需求生成与修改代码",
            },
            {
              title: "开发资料引用",
        ...
        },
        {
          ...
          cards: [
            ...
            {
              title: "切换即切换",
              description: "项目切换自动切换上下文与配置",
            },
            {
              title: "多人协作隔离",
              description: "多用户、多项目会话互不混淆",
            },
      ...
      business: {
        ...
        demo: {
          title: "项目工作台 · 会话示例",
          messages: [
            "在这个项目里，帮我重构支付模块的错误处理",
            "正在基于当前项目上下文分析……",
            "已识别支付模块的错误处理模式，生成统一异常处理方案与重构代码。",
        ...
        scenes: [
          {
            ...
            actions: [
              { label: "了解码多多更多能力 →", href: "/product/coding" },
            ],
          },
          {
            title: "多团队共用码多多",
          ...
          },
          {
            ...
            actions: [
              { label: "了解模型选择与适配 →", href: "/product/model" },
            ],
          },
        ],
      },
  ...
  it("locks the complete coding session page", () => {
    expect(getCodingSubpage("coding-session")).toStrictEqual({
      slug: "coding-session",
      name: "会话管理",
      hero: {
        eyebrow: "编程中心｜会话管理",
      ...
      business: {
        ...
        demo: {
          title: "码多多 · 会话示例",
          messages: [
            "继续昨天的开发任务，先看一下关单逻辑的状态",
            "正在加载历史会话……",
            "已恢复上下文：关单逻辑已完成，超时时间已配置化；当前可继续开发测试。",
            "会话：订单系统 · 快照 V2",
            "输入你的开发需求…",
            "发送",
          ],
  ...
  it("locks the complete coding mobile page", () => {
    expect(getCodingSubpage("coding-mobile")).toStrictEqual({
      slug: "coding-mobile",
      name: "移动接入",
      hero: {
        eyebrow: "编程中心｜移动接入",
  ...
  it("locks the complete coding standard page", () => {
    expect(getCodingSubpage("coding-standard")).toStrictEqual({
      ...
      business: {
        ...
        demo: {
          ...
          messages: [
            "检查刚生成的支付接口代码",
            "正在按项目规范执行质量校验……",
            "校验完成：发现 1 处安全风险（SQL 拼接）与 1 处性能建议，已给出修正代码。",
            "规范：企业规范 X · 已复检通过",
            "输入代码或需求…",
            "发送",
          ],
        ...
        scenes: [
          ...
          },
          {
            ...
            actions: [
              { label: "了解模型与资源适配 →", href: "/product/model" },
            ],
          },
        ],
      },
