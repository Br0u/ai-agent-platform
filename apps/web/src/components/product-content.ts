...
export const fullStackArchitecture = {
  apps: {
    title: "智能应用广场",
    items: ["智能办公机器人", "智能问数机器人", "智能视觉机器人", "智能编程机器人"],
  },
  aiDev: {
    title: "智能体开发中心",
  ...
  modelEngineering: {
    title: "模型工程中心",
    items: ["模型花园", "模型部署", "模型训练", "模型评估", "密钥管理", "流量统计"],
  },
  modelManagement: {
    title: "模型管理平台",
    models: [
...
export const officeAgents = [
  {
    code: "OA01",
    name: "公文写作助手",
    description: "覆盖 15 类法定公文和事务公文的全流程 AI 写作工具，支持模板生成、AI 润色、内容校审与合规审核。",
    detailDescription: "整体页面分为左侧主编辑区、右侧多功能侧边栏。侧边栏包含：生成大纲、生成公文、格式排版、AI 润色、公文校检、提炼总结、对话写作功能。",
    capabilities: ["15+ 法定/事务公文模板", "AI 辅助写作 (拟纲/扩写)", "智能纠错与合规校检"],
    highlights: ["法定公文 + 事务公文全覆盖", "一键沉浸式排版与打印", "边写边聊的 Copilot 体验"],
    workflow: [
      { step: "选择公文类型", description: "从预置的 15 种类型中选择并提供核心素材。" },
      { step: "生成与调整大纲", description: "AI 自动生成大纲，用户可手动微调。" },
      { step: "全文生成与润色", description: "一键生成全文，使用 AI 进行局部扩写或风格润色。" },
      { step: "合规校验与定稿", description: "自动检查错别字、敏感词及公文格式合规性。" },
    ],
  ...
  },
  {
    code: "OA02",
    name: "投标助手",
    description: "针对招投标场景深度优化的技术标辅助工具，支持长文档多模态解析、历史标书参考与评分项检查。",
    detailDescription: "内置长文档处理引擎与多模态解析模型（如 Qwen2-VL），支持图文并茂的标书内容提取与结构化理解，提供从大纲到正文的一站式撰写。",
    capabilities: ["超长上下文理解", "多模态历史标书参考", "复杂图表自动生成"],
    highlights: ["万字长文档精准解析", "历史优秀标书智能关联检索", "自动生成技术架构图表"],
    workflow: [
      { step: "解析招标文件", description: "上传招标文件，AI 提取核心评分点与要求。" },
      { step: "搭建标书大纲", description: "结合要求自动生成技术标或商务标大纲。" },
      { step: "调用私有知识库", description: "在生成正文时自动引用企业历史优秀案例段落。" },
      { step: "合规与评分预估", description: "对照招标要求检查遗漏项并给出优化建议。" },
    ],
  ...
  },
  {
    code: "OA03",
    name: "合同审核",
    description: "面向法务与业务人员的智能合同审阅系统，提供三级风险预警、条款对比与智能修订建议。",
    detailDescription: "支持 Word/PDF 格式合同比对，结合企业法务知识库，自动识别履约风险、违约金比例异常、主体资质等 50+ 类潜在风险。",
    capabilities: ["三级风险红绿灯预警", "双屏条款智能比对", "合规修订建议生成"],
    highlights: ["毫秒级全文风险扫描", "法务知识库无缝对接", "修改轨迹全程追踪"],
    workflow: [
      { step: "上传合同文件", description: "支持单文件审核或双文件差异比对。" },
      { step: "自动风险扫描", description: "识别并高亮高、中、低三个等级的风险条款。" },
      { step: "查看修订建议", description: "针对风险条款提供符合企业法务要求的修改建议。" },
      { step: "导出审阅报告", description: "一键生成包含所有风险点与建议的审阅报告。" },
    ],
  ...
  },
  {
    code: "OA04",
    name: "智能会议",
    description: "覆盖会前准备、会中记录、会后总结的端到端会议助手，支持语音转录与待办事项自动提取。",
    detailDescription: "实时语音转写（ASR）接入，自动区分发言人。会后快速提炼会议纪要、生成思维导图，并将 Action Items 分配给相关责任人。",
    capabilities: ["实时多语种语音转录", "发言人声纹分离", "决议与待办自动提取"],
    highlights: ["会后一键输出标准纪要", "思维导图脑图生成", "多角色独立记录线索"],
    workflow: [
      { step: "会前议程设置", description: "提供背景资料，生成会议议程建议。" },
      { step: "会中实时转录", description: "语音实时转化为文字，动态提取关键讨论点。" },
      { step: "会后纪要生成", description: "五分钟内输出完整会议记录、决议与待办事项清单。" },
      { step: "任务追踪分发", description: "将提取的待办事项自动对接至项目管理工具。" },
    ],
...
export const supportedModels = [
  {
    category: "开源/商业大语言模型",
    models: ["DeepSeek-V3", "DeepSeek-R1", "Qwen2.5 系列", "Llama-3 系列", "Baichuan 系列", "ChatGLM 系列"],
    note: "全面兼容 OpenAI 接口规范，支持无缝切换底层引擎",
  },
  {
    category: "多模态与垂直模型",
    models: ["Qwen-VL (视觉理解)", "SenseVoice (语音识别)", "BGE-m3 (向量化)", "Stable Diffusion (图像生成)"],
...
export const customerValues = [
  ...
  {
    title: "非结构化数据转化为数字资产",
    description: "强大的知识工程流水线，让沉睡的文档、图纸变为随时可调用的智能大脑。",
  },
  {
    title: "降低开发门槛，缩短落地路径",
    description: "通过可视化工作流与丰富的预置智能体，将模型能力低成本融入业务。",
  },
  {
    title: "权限、数据、算力统一管控",
    description: "企业级控制面板，实现多租户资源隔离、成本分摊与细粒度权限审计。",
  },
] as const;
