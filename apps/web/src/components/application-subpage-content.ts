...
export const applicationSubpageSlugs = [
  "app-writing",
  "app-bidding",
  "app-contract",
] as const;

const applicationSubpages = [
  {
    slug: "app-writing",
    name: "通用文本写作",
    hero: {
    ...
    sections: [
      {
        ...
        cards: [
          ...
          },
          {
            ...
            answer: "沉淀官方公文写作经验，大纲先行、分步生成，格式有据可依。",
            actions: [
              {
                label: "了解公文撰写流程 →",
      ...
      },
      {
        ...
        cards: [
          ...
          {
            title: "润色优化",
            description: "对文案精修打磨，统一语气与表达，提升可读性与专业度。",
          },
          {
            title: "结构整理",
            description:
    ...
    business: {
      ...
      points: [
        ...
        { title: "有据可溯", description: "引用文件与知识库，生成内容有出处" },
        { title: "一键润色", description: "扩写、简写、改写、续写随时可用" },
      ],
      values: [
        { title: "写得更快", description: "提纲到成稿分步完成，缩短起稿时间" },
        {
          title: "行文更规范",
      ...
      demo: {
        ...
        messages: [
          "写一份关于开展公文写作培训的通知",
          "正在生成文章大纲……",
          "已生成大纲：一、总体要求；二、培训时间与地点；三、参训人员；四、培训内容。",
          "来源：公文写作经验库",
          "按大纲生成全文，语气正式一些",
          "正在分步生成全文……",
          "已生成全文初稿，可继续扩写、简写或改写后定稿。",
          "参考：已上传 5 份相关文件",
          "请输入你的写作要求…",
          "发送",
        ],
  ...
  },
  {
    ...
    business: {
      ...
      demo: {
        title: "智能投标助手",
        messages: [
          "已上传「鲲鹏服务器采购项目」招标文件，帮我梳理应标要点",
          "正在智能解析招标文件……",
          "已提取项目需求、资质门槛、评分标准与技术参数，识别 3 个得分关键点与 2 处潜在风险。",
          "来源：招标文件智能解析",
          "按评分结构生成标书大纲",
          "已生成 8 个章节大纲，预计约 122 页，可逐章撰写、随时调整。",
          "对照：评标办法评分点",
          "请输入你的问题…",
          "发送",
        ],
  ...
  },
  {
    ...
    sections: [
      {
        ...
        cards: [
          ...
          },
          {
            number: "问题 03",
            title: "风险怎么早发现？",
            description: "风险点发现晚、定位难，人工复核费时费力，交付周期长。",
    ...
    business: {
      ...
      demo: {
        title: "合同智能审查助手",
        messages: [
          "已上传保理合同，请按保理合同审核标准，作为保理商严格审查",
          "正在逐条核对合同条款……",
          "已按保理合同清单完成审查，检测 19 处合同风险：常规 4 处、次要 12 处、重要 3 处。",
          "审查清单：保理合同 · 审查尺度：强势",
          "重点标出重要风险，定位到条款",
          "重要风险已标注并定位：违约金上限过低、生效条件不确定、回购义务缺失。",
          "条款定位：违约处理条款 / 合同生效条款 / 回购义务条款",
          "请输入你的审查问题…",
          "发送",
        ],
...
export function getApplicationSubpage(slug: string): PlatformPage | undefined {
  return applicationSubpages.find((page) => page.slug === slug);
}
