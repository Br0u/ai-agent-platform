...
describe("prototype agent subpage content contract", () => {
  it("registers exactly the four agent subpages in source order", () => {
  ...
  it("locks the complete enterprise knowledge agent page", () => {
    expect(getAgentSubpage("agent-knowledge")).toStrictEqual({
  ...
  it("locks the complete data agent page", () => {
    expect(getAgentSubpage("data-agent")).toStrictEqual({
      slug: "data-agent",
      name: "智能问数助手",
      hero: {
  ...
  it("locks the complete video agent page", () => {
    expect(getAgentSubpage("agent-video")).toStrictEqual({
      slug: "agent-video",
      name: "视频理解与智能视觉助手",
      hero: {
  ...
  it("locks the complete agent orchestration page", () => {
    expect(getAgentSubpage("agent-orchestration")).toStrictEqual({
