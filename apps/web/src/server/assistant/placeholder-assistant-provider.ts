...
const REPLIES: Record<AssistantPresetQuestion, AssistantProviderReply> = {
  "如何开始了解平台？": {
    content: "你可以从快速开始文档了解平台结构和使用入口。",
    suggestedActions: [{ label: "查看快速开始", href: "/docs#quick-start" }],
  },
  "如何获取部署支持？": {
    content: "当前可通过商务咨询提交部署需求，由相关人员进一步确认。",
    suggestedActions: [{ label: "联系商务", href: "/contact" }],
  },
  "如何提交产品问题？": {
    content: "你可以前往客户支持页面查看问题提交入口。",
    suggestedActions: [{ label: "前往客户支持", href: "/support" }],
  },
};

const GENERIC_REPLY: AssistantProviderReply = {
